    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-28 pb-24 text-center relative">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/login"
            className="border border-white/10 text-white/60 px-6 py-3 rounded-lg text-sm hover:bg-white/5 hover:text-white transition-colors"
          >
            Soy cliente →
          </Link>
        </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                desc: "Acceso directo a tu asesor, actualizaciones de mercado y portal personal disponible 24/7.",
              },
            ].map((s) => (
              <div key={s.title} className="bg-white/3 border border-white/5 rounded-2xl p-6 hover:border-white/10 transition-colors">
                <div className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center mb-5 text-lg">
                  {s.icon}
                </div>
